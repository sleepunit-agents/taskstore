...
const preamble = {
  ...
  exclusions: [
    ...
    "Residue: ready's 'never by id' ordering is unfixturable in this interchange — $-token normalization renders generated ids in creation rank, so id order and creation order cannot be made to diverge in a fixture corpus. The createdAt half of the never-clause is fixtured (fx-ready-sort, fx-list, fx-export); the id half binds as prose.",
  ],
...
fx(
  ...
  [
    ...
    { op: "create", actor: A, at: T0, criterionId: "ac1", priority: 9, title: "lone criterion, bad priority" },
    ...
    { op: "create", actor: A, at: T0, priority: 5, title: "one past the edge" },
...
fx(
  "fx-close",
  "close stamps closedAt and an optional closeReason; claim stamps survive a close; a non-string reason on a LEGAL target is E_BAD_FIELD alone and closes nothing; a never-claimed task closes straight from open without a closeReason key.",
  [
    ...
    { op: "close", actor: A, at: T4, id: "$2", reason: 42 },
...
fx(
  ...
  [
    ...
    { op: "comment", at: T3, id: "$1", text: "anonymous" },
    { op: "comment", actor: A, at: 42, id: "$1", text: "numeric clock" },
    { op: "comment", actor: A, at: "2026-06-30T23:59:60Z", id: "$1", text: "leap second" },
    { op: "show", id: "$1" },
  ],
  [
    createOK("$1"),
...
fx(
  ...
  [
    ...
    { op: "update", actor: A, at: T3, id: "$1", set: { priority: 5 } },
  ...
  [
    ...
    },
    {
      ...
      tasks: [
        ...
        { assignee: 9, createdAt: "2026-01-09T00:00:00Z", createdBy: 7, description: 7, id: "legacy-11", priority: 2, status: "open", title: "mistyped optionals and createdBy", type: "task" },
        { comments: [{ actor: A, at: "2026-01-06T00:00:00", text: "offsetless comment" }, { at: "2026-01-06T01:00:00Z" }, { actor: A, at: 42, text: "numeric clock in a record" }], createdAt: "2026-01-06T00:00:00Z", createdBy: A, criterionId: "ac1", id: "legacy-5", priority: 2, specItemRef: "spec:mini/itX", status: "open", title: "first of colliding pair", type: "task" },
...
fx(
  ...
  [
    ...
    showOK({
      closeReason: "cancelled", closedAt: "2026-03-01T00:00:00Z",
      comments: [{ actor: "jonathan", at: "2026-02-01T00:00:00Z", text: "calling it" }],
